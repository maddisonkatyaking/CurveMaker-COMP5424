...
#####################
    ...
    testCollapsibleButton.text = "Remove Curve"
    self.layout.addWidget(testCollapsibleButton)
    testFormLayout = qt.QFormLayout(testCollapsibleButton)
    
    # test button
    # 
    self.testButton = qt.QPushButton("Remove Curve")
    self.testButton.toolTip = "Remove a curve."
    self.testButton.name = "Remove Curve"
    testFormLayout.addWidget(self.testButton)
    self.testButton.connect('clicked()', self.onTestButton)
    ##
    ##################### MADDI ###############################
...
########################## MADDI ######################    
  def onTestButton(self,moduleName="CurveMaker"):
